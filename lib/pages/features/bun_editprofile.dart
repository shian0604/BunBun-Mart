...
import 'package:bunbunmart/data/controller/user/updatename_controller.dart';
...
class BunEditProfile extends StatefulWidget {
  const BunEditProfile({super.key});

  @override
  State<BunEditProfile> createState() => _BunEditProfileState();
}

class _BunEditProfileState extends State<BunEditProfile> {
              ...
              children: [
                ...
                Form(
                  ...
                  child: MyInputField(
                    ...
                    controller: controller.updateduserName,
                    validator:
