...
class BunReauthenticateUser extends StatefulWidget {
  const BunReauthenticateUser({super.key});

  @override
  State<BunReauthenticateUser> createState() => _BunReauthenticateUserState();
}

class _BunReauthenticateUserState extends State<BunReauthenticateUser> {
                  ...
                  children: [
                    Align(
                      ...
                      child: WhiteBackButton(
                        onPressed: () => Get.off(() => const BunBunSettings()),
                      ),
                    ),
                    BunbunHeader(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 16),
                        BunButton(
                          onTap: () => controller.reAuthenticateEmailAndPasswordUser(),
